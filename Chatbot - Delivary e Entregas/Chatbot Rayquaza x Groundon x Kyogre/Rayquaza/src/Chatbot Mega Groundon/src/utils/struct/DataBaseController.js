...
class DataBaseController {
  constructor() {
    this.sanduicheTradicionalFile = 'src/Chatbot Mega Groundon/repository/cardapio_1.json';
    this.acaiFile = 'src/Chatbot Mega Groundon/repository/cardapio_2.json';
    this.petiscosFile = 'src/Chatbot Mega Groundon/repository/cardapio_3.json'
  }
