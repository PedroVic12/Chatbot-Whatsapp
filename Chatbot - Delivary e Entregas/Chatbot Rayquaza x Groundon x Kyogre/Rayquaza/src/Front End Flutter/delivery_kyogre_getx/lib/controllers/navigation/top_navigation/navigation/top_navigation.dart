      ...
      title: Row(
        children: [
          ...
          IconButton(onPressed: (){
              ...
              Icons.settings,color: CupertinoColors.black.withOpacity(.7)
          )),

          Stack(
            children: [
              IconButton(onPressed: (){}, icon: Icon(
                Icons.notifications_rounded, color: CupertinoColors.black.withOpacity(.7),
              )),
          ...
          CustomText(text: 'Pedro Victor', color: CupertinoColors.inactiveGray),
          ...
          Container(
            ...
            child: Container(
              ...
              child: CircleAvatar(
                ...
                child: Icon(Icons.person, color: CupertinoColors.black,),
              ),
            ),
          )
